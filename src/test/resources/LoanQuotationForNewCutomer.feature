...
Feature: Loan Quotation for Qatas Customer
  As Customer I should be able to quote Loan

  @RegisteredQantascustomer
  Scenario Outline: Quote a loan for Registered Qatas customer
  ...
  Scenario Outline: Quote a loan for unRegistered Qatas customer
